<template>
    <div id="altWatcherContainer" v-if="computedLinks.length > 0">
        <div class="watch-online-placeholer">
            <div class="watch-online">
                <a
                        v-if="current"
                        class="b-link_button dark watch-online"
                        style="float: left; width: calc(100% - 31px)"
                        :href="computedUrl"
                        target="_blank"
                >
                    {{current.title}}
                ...
                <a
                        @click="bar = !bar"
                        class="b-link_button dark"
                        style="width: 31px; float: right; heigth: 31px">
                    ▼
                </a>
            </div>
            <div class="clearfix"></div>
        </div>
        <div v-show="bar" class="block watch-online" style="top: 5px">
            <a
            ...
            <div class="block watch-online" style="top: 5px">
                <table width="100%">
                    <tr>
                        <td>
                            <a
                                    ...
                                    :class="lang === 'ru' ? 'b-link_button dark' : 'b-link_button'">
                                ru
                            </a>
                        </td>
                        <td>
                            <a
                                    ...
                                    :class="lang === 'en' ? 'b-link_button dark' : 'b-link_button'">
                                en
                            </a>
                        </td>
                        <td v-if="titles.jp">
                            <a
                                    ...
                                    :class="lang === 'jp' ? 'b-link_button dark' : 'b-link_button'">
                                jp
                            </a>
                        </td>
                    </tr>
    ...
    export default {
        ...
        methods: {
            ...
            parseTitles() {
                ...
                let otherNames = document.querySelector('.other-names.click-loader');
