...
/* harmony import */ var _options_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./options/config */ "./options/config.js");
var _this = undefined;
...
var linksDb;
_libs_db__WEBPACK_IMPORTED_MODULE_0___default.a.open({
  server: 'linksDb',
  version: 1,
  schema: {
    link: {
...
function _onStartup() {
  _onStartup = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee() {
    var serv, results, _ref, data;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _libs_db__WEBPACK_IMPORTED_MODULE_0___default.a.open({
              server: 'linksDb',
              version: 1,
              schema: {
                link: {
          ...
          case 8:
            _context.next = 10;
            return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("".concat(_options_config__WEBPACK_IMPORTED_MODULE_3__["apiDomain"], "/altWatcher/defaultLinks"));
...
var __WEBPACK_AMD_DEFINE_RESULT__;function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }
    ...
    Object.keys(schema).some(function (tableName) {
      ...
      Object.keys(table.indexes || {}).some(function (indexKey) {
        try {
          ...
          index = index && _typeof(index) === 'object' ? index : {}; // Errors for which we are not concerned and why:
